...
- 🏆 Compete for $40,000 in cash prizes across three tracks   
    ...
    💳 Get $50 in AWS credits to cover your build costs (go to the [Resources tab](https://agentsforhumans.devpost.com/resources) for request form)  
    🌍 Open to developers worldwide, solo or team, new or seasoned  
    📝 Earn bonus points by publishing your build story on [builder.aws.com](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el) (see [rules](https://agentsforhumans.devpost.com/rules) for details)
...
_Deploying with AgentCore is a smart architectural choice and will strengthen your **Technical Implementation** score, but it's not required._  
...
⭐ **Bonus Points** Publish a post on [builder.aws.com](http://builder.aws.com/) covering your build journey and use of AWS for this hackathon. Use Agents for Humans in your title. You can submit more than one post. Posts must be publicly published before the submission deadline. See [Full Rules](https://agentsforhumans.devpost.com/rules) for details.
...
1. **Create your AWS Account**  [Sign up for a free AWS Account →](https://signin.aws.amazon.com/signup?request_type=register)
2. **Install the Strands Agents SDK** Available in Python and TypeScript. You can have a working agent running in under 20 minutes.
...
1. [**Request your AWS Credits**](https://forms.gle/Ssr8zLw4afKg114M7) Registered participants can request $50 in AWS Promotional Credits to cover build costs, while supplies last. Requests must be submitted by **September 11, 2026 at 12pm PT**. Subject to [AWS Promotional Credits terms](https://aws.amazon.com/awscredits/).

##### 📖 Learning Resources

**New to Strands or agentic AI? Start here:**

- [Getting Started with Strands Agents: Step-by-Step Guide](https://builder.aws.com/content/2xCUnoqntk2PnWDwyb9JJvMjxKA/getting-started-with-strands-agents-a-step-by-step-guide) — Beginner walkthrough from AWS, zero to working agent
    
- [Strands Agents SDK: Technical Deep Dive](https://aws.amazon.com/blogs/machine-learning/strands-agents-sdk-a-technical-deep-dive-into-agent-architectures-and-observability/) — Architecture patterns and observability for seasoned builders
    
- [Introducing Strands Agents (AWS Open Source Blog)](https://aws.amazon.com/blogs/opensource/introducing-strands-agents-an-open-source-ai-agents-sdk/) — How it works and why it was built
    
-  [Strands Agents Playlist](https://agentsforhumans.devpost.com/youtube.com/watch?v=ZpXWGjISMs8&list=PLDzwjhH-4yhU%5C) 14 free videos

**Want to go further with AgentCore?**

- [Amazon Bedrock AgentCore Documentation →](https://docs.aws.amazon.com/bedrock-agentcore/)
    
- [AgentCore Quickstart (CLI) →](https://docs.aws.amazon.com/bedrock-agentcore/latest/devguide/agentcore-get-started-cli.html)
...
_Not sure where to start?_ _Read through these; the best project ideas usually start with a_ _question, not an answer._
...
_Updated 8/12/26 to remove requirement of #AgentsforHumans in Blog Post Bonus Submission items._
...
Entrants may enter by visiting [agentsforhumans.devpost.com](https://agentsforhumans.devpost.com/agentsforhumans.devpost.com) (“Hackathon Website”) and following the below steps:
...
2. Entrants will obtain access to the required developer platform and databases and complete a Project described below in “Project Requirements. Use of the developer tools will be subject to the license agreement related thereto. Entry in the Hackathon constitutes consent for the Sponsor and Devpost to collect and maintain an entrant’s personal information for the purpose of operating and publicizing the Hackathon.
    

3. Sign up for an [AWS Account.](https://signin.aws.amazon.com/signup?request_type=register)
    
4. [Install the Strands Agents SDK](https://strandsagents.com/docs/user-guide/quickstart/overview/) 
    

5. Entrants may request $50 in AWS Promotional Credits for the purpose of completing your Project for the hackathon while supplies last. AWS Promotional Credits can only be requested by individuals registered for the Hackathon. In order to request AWS Promotional Credits, you must complete the form at: [https://forms.gle/6sjzKiX6bKUMA5NEA](https://forms.gle/6sjzKiX6bKUMA5NEA) by **September 11th at 12pm PT**. AWS Promotional Credits are subject to the AWS Promotional Credits terms and conditions found at: [https://aws.amazon.com/awscredits/](https://aws.amazon.com/awscredits/). AWS Promotional Credits are not redeemable for cash and expire October 31st. AWS Credits can be used for most AWS services including Strands Agents required for this hackathon.
    

_NOTE: Additional charges incurred by the Entrant for the use of AWS products are the responsibility of the Entrant. Entrants are encouraged to monitor their usage of services so as to not incur additional charges._

1. Complete and enter all of the required fields on the “Enter a Submission” page of the Hackathon Website (each a “Submission”) during the Submission Period and follow the requirements below.
...
_Deploying with Amazon Bedrock AgentCore is a smart architectural choice and will strengthen your Technical Implementation score, but it's not required._ 
...
Optional [builder.aws](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el) Blog Post for Bonus Points: Submitting the following optional [builder.aws](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el) Blog Post will positively impact the score the submission receives from the Judges as outlined in Section 6. 

Publish a [builder.aws](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el) Blog Post: Cover how you journey building and implementing AWS for this hackathon. You can submit more than one blog post. The Blog Post must be published publicly on [builder.aws.com](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el). Should use Agents for Humans in the Title.
...
**Bonus [builder.aws](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el) Blog Post (optional):** Submissions that advance to Stage Two may earn up to 0.6 additional points on top of their score by publishing a [builder.aws](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el) Blog Post covering your journey building and implementing AWS for this hackathon. You can submit more than one piece of content (0.2 each). The content must be publicly posted to [builder.aws](https://builder.aws.com/?trk=07ec4eea-6ca4-48f2-8162-c293e779e629&sc_channel=el). 
...
|Grand Prize|$10,000<br><br>Featured in AWS Social Post<br><br>Virtual Roundtable discussion with AWS Experts|1|All eligible submissions|
|Everyday Agents Prizes|
|Gold Agent|$5000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Everyday Agents Track|
|Silver Agent|$3000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Everyday Agents Track|
|Bronze Agent|$2000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Everyday Agents Track|
|Professional Agents Prizes|
|Golden Agent|$5000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Professional Agents Track|
|Silver Agent|$3000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Professional Agents Track|
|Bronze Agent|$2000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Professional Agents Track|
|Good Neighbor Agents Prizes|
|Golden Agent|$5000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Good Neighbor Agents Track|
|Silver Agent|$3000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Good Neighbor Agents Track|
|Bronze Agent|$2000<br><br>Featured in AWS Social Post|1|All eligible submissions that enter the Good Neighbor Agents Track|
...
Information collected from Entrants is subject to Devpost’s Privacy Policy, which is available at [https://info.devpost.com/privacy](https://info.devpost.com/privacy) and Sponsor handles your information in accordance with [AWS Privacy Notice](https://aws.amazon.com/privacy/).
